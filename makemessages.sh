...
# Run the django-admin makemessages command for Farsi locale,
# excluding the venv and utils directories, using the specified settings.
django-admin makemessages -i venv -i utils -l fa --settings="${DJANGO_SETTINGS_MODULE}"
